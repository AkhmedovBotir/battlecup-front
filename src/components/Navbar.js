      ...
      <div className='max-w-[1062px] mx-auto px-4'>
        <div className='flex items-center justify-between h-16'>
          ...
          <Link href="/" className='flex items-center'>
            <img src="/img/icon.png" alt="BattleCup" className='h-8' />
          ...
          <nav className='hidden md:flex items-center space-x-8'>
            <Link href="#" className='text-[#8B95A9] hover:text-white transition-colors'>Новости</Link>
            <Link href="#" className='text-[#8B95A9] hover:text-white transition-colors'>Форум</Link>
            <Link href="#" className='text-[#8B95A9] hover:text-white transition-colors'>Рейтинг</Link>
            <Link href="#" className='text-[#8B95A9] hover:text-white transition-colors'>Турниры</Link>
            <Link href="#" className='text-[#8B95A9] hover:text-white transition-colors'>Магазин</Link>
            <Link href="#" className='text-[#8B95A9] hover:text-white transition-colors'>Поддержка</Link>
          </nav>

          {/* Navigation - Mobile */}
          <nav className='fixed md:hidden bottom-0 left-0 right-0 bg-[#12151B] border-t border-[#181C25] z-50'>
            <div className='flex justify-around py-3'>
              <Link href="#" className='flex flex-col items-center text-[#8B95A9] hover:text-white transition-colors'>
          ...
          {user ? (
            <div className='flex items-center space-x-4'>
              <Link href="/messages" className='text-[#8B95A9] hover:text-white'>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7 8.5L9.94202 10.2394C11.6572 11.2535 12.3428 11.2535 14.058 10.2394L17 8.5" stroke="#9EA8BD" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M2.01577 13.4756C2.08114 16.5411 2.11383 18.0739 3.24496 19.2093C4.37609 20.3448 5.95034 20.3843 9.09884 20.4634C11.0393 20.5122 12.9607 20.5122 14.9012 20.4634C18.0497 20.3843 19.6239 20.3448 20.755 19.2093C21.8862 18.0739 21.9189 16.5411 21.9842 13.4756C22.0053 12.4899 22.0053 11.51 21.9842 10.5244C21.9189 7.45886 21.8862 5.92609 20.755 4.79066C19.6239 3.65523 18.0497 3.61568 14.9012 3.53657C12.9607 3.48781 11.0393 3.48781 9.09882 3.53656C5.95034 3.61566 4.37609 3.65521 3.24496 4.79065C2.11383 5.92608 2.08114 7.45885 2.01577 10.5243C1.99474 11.51 1.99474 12.4899 2.01577 13.4756Z" stroke="#9EA8BD" strokeWidth="1.5" strokeLinejoin="round" />
                </svg>
              </Link>
              <Link href="/notifications" className='text-[#8B95A9] hover:text-white'>
                <svg width="28" height="26" viewBox="0 0 28 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M2.52992 16.7696C2.31727 18.1636 3.268 19.1312 4.43205 19.6134C8.89481 21.4622 15.1052 21.4622 19.5679 19.6134C20.732 19.1312 21.6827 18.1636 21.4701 16.7696C21.3394 15.9129 20.6932 15.1995 20.2144 14.5029C19.5873 13.5793 19.525 12.5718 19.5249 11.5C19.5249 7.35786 16.1559 4 12 4C7.84413 4 4.47513 7.35786 4.47513 11.5C4.47503 12.5718 4.41272 13.5793 3.78561 14.5029C3.30684 15.1995 2.66061 15.9129 2.52992 16.7696Z" stroke="#9EA8BD" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M8 21C8.45849 22.7252 10.0755 24 12 24C13.9245 24 15.5415 22.7252 16 21" stroke="#9EA8BD" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  <circle cx="21" cy="7" r="6" fill="#FE3030" stroke="#0D0F14" strokeWidth="2" />
                </svg>
              </Link>
