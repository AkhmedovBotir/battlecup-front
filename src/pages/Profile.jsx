...
export default function Profile() {
    ...
    useSEO({
        title: `${user.nickname} - ${user.rank}`,
        description: `${user.nickname} profili - ${user.rank}, ${user.rating} reytingga ega. BattleCup platformasidagi statistikasi va yutuqlari.`,
        keywords: "dota 2, player profile, rank, statistics, battlecup",
        image: `https://battlecup.uz/profiles/${user.nickname}.jpg`
    });
