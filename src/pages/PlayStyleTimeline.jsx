    ...
    <div className="">
      {timelineData.map((teamData, teamIndex) => (
        <div key={teamIndex} className="my-5 bg-[#12151B] p-4 rounded-lg">
          {/* Timeline Numbers */}
          <div className="flex">
            <h3 className="text-white text-md mb-2 w-[195px]">{teamData.team}</h3>
            <div className="flex-1 flex flex-row items-center justify-between">
              {Array(25).fill(null).map((_, index) => (
                <div key={index} className="h-6 flex items-center justify-center w-[30px]">
                  <span className="text-[#8993A6] text-md">{index + 1}</span>
                </div>
              ))}
            </div>
          </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex-1 flex flex-row items-center justify-between">
                    {player.items.map((item, index) => (
                      <div
                        key={index}
                        className={`w-[30px] h-8 flex items-center justify-center relative ${
                          !item 
